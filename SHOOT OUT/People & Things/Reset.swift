...
class Reset: SKScene{
    ...
    lazy var resetButton: SKSpriteNode = {
        ...
        sprite.position = CGPoint(x: 0, y: ScreenSize.height * -0.2)
        sprite.zPosition = 2
        sprite.name = "button"
    ...
    lazy var changeDifficulty: SKSpriteNode = {
        ...
        sprite.position = CGPoint(x: 0, y: ScreenSize.height * -0.4)
        sprite.zPosition = 2
        sprite.name = "button"
        sprite.scaleTo(screenWidthPercentage: 0.1)
        return sprite
...
//            }
    ...
    //Warning this code to add a share feature is more trouble than it is worth
    ...
    //if let storiesUrl = URL(string: "instagram-stories://share") {
        //if UIApplication.shared.canOpenURL(storiesUrl) {
            //let image = makeSnapshot()!.imageRotated(on: 0)
...
//    }
//    func alert() {
//      let alertController = UIAlertController(title: "Want to open Instagram?", message: "Do you have your parent's permission to open Instagram?", preferredStyle: .alert)
...
//    }
    override func didMove(to view: SKView) {
        ...
        spawnLabel(text: "Hard Mode High Score: \(UserDefaults().integer(forKey: "HighScore"))", pos: CGPoint(x: 0, y: ScreenSize.height * 0.25), label: highScoreLabel)
        spawnLabel(text: "Easy Mode High Score: \(UserDefaults().integer(forKey: "HighScoreEasy"))", pos: CGPoint(x: 0, y: ScreenSize.height * 0.25 + 30), label: easyhighScoreLabel)
